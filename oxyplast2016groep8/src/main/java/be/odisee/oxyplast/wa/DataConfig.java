...
public class DataConfig {
    ...
    public BasicDataSource datasource(){
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/oxyplast");
        ds.setUsername("oxyplastuser");
        ds.setPassword("oxyplastuserpw");
        ds.setInitialSize(5);
        ds.setMaxActive(10);
    ...
    public SessionFactory sessionFactory() throws Exception{
        ...
        sf.setPackagesToScan(new String[]{"be.odisee.oxyplast.domain"});
