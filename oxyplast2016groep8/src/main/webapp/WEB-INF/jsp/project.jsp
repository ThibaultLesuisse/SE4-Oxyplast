		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td name="dbLabelNaam">Naam</td>
						<td name="dbDataNaam"><c:out value="${project.naam}" /></td>
					</tr>
					<tr>
						<td name="dbLabelStatus">Status</td>
						<td name="dbDataStatus"><c:out value="${project.status}" /></td>
					</tr>
					<tr>
						<td name="dbLabelTeamID">TeamId</td>
						<td name="dbDataTeamID"><c:out value="${project.teamId}" /></td>
					</tr>
				</tbody>
			</table>
			...
			<a name="terugButton" href='<c:out value="${home}" />'>Terug</a>
		</div>
	</div>
</body>
</html>
